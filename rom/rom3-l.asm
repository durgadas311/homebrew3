...
L0198:	call	L018d	; print addr
	mov	e,m
	inx	h
	mov	a,m
	dcx	h
	call	L022a	; print hi byte
	mov	a,e
...
; HL is not carried forward from previous command.
...
; C=1 if number was entered (dcr c => ZR), HL=number
L04bc:	cpi	CR		;; 04bc: fe 0d       ..
	...
	cpi	'T'	; TBD - terminal/transfer mode?
	jz	L0653	; TBD - ???
	cpi	'?'	; TBD - set 12-bit addr to PIO device?
	jz	L065b	; TBD
